...
<html>
<head>
    <title>clientflowcrm - login panel</title>
...
<div class="login-page">
    ...
    <div class="form">
        ...
        <form method="POST" action="{{ route('login/process') }}" class="login-form">
            {{ csrf_field() }}
            <input id="email" type="email" name="email" placeholder="Write your email here ..." value="admin@demo.com"/>
            <input id="password" type="password" name="password" placeholder="Write your password here ..." value="12345678"/>
            <button>login</button>
